...
* [Строки string](INFO_collections.md/#stroki)
* [Списки list](#spiski)
* [Срезы](#srezy)
* [Кортежи tuple](#srezy)
* [Множества set](INFO_collections.md/###Операции-с-множествами:)
* [Словари dictionary](#srezy)
* [Сравнение коллекций](#srezy)
* [Генератор словарей List Comprehension](#srezy)
* [Ошибки в Python](#srezy)
* [ПОСЛЕДОВАТЕЛЬНОСТИ](#ПОСЛЕДОВАТЕЛЬНОСТИ)


![заголовок](pthn.png) **`С Т Р О К И string`** <a name="stroki"></a> 
=============================================
```python
...
# ![заголовок](pthn.png) **`С П И С К И`** <a name="spiski"></a>
...
# ![заголовок](pthn.png) **`С Р Е З Ы`**<a name="srezy"></a>
...
# ![заголовок](pthn.png) **`К О Р Т Е Ж И`** <a name="kortezhi"></a>
...
# ![заголовок](pthn.png) **`М Н О Ж Е С Т В А`** <a name="mnozhestva"></a>
...
# ![заголовок](pthn.png) **`С Л О В А Р И`** <a name="slovari"></a>
===========================================
...
# ![заголовок](pthn.png) **`СРАВНЕНИЕ КОЛЛЕКЦИЙ`** <a name="sravnenie"></a>


| Тип коллекции             |Изменяемость| Индексация | Уникальность | Создание |
|:-------------------------:|:----------:|:----------:|:------------:|:--------:|
| Список (list)             |  +         |      +     |     -        | [ ], list()
| Кортеж (tuple)            |  -         |      +     |     -        | ( ), tuple()
| Строка (string)           |  -         |      +     |     -        | " ", ' '
| Множество (set)           |  +         |      -     |     +        | {elem1, elem2}, set()
| Неизм.множ-во (frozenset) |  -         |      -     |     +        | frozenset()
| Словарь (dict)            |+ элементы  |      -     | + элементы   | { },
|                           |- ключи     |            | + ключи      | {key: value, },
|                           |+ значения  |            | - значения   | dict()


# ![заголовок](pthn.png) **`LIST COMPREHENSION`** <a name="comprehension"></a>
...
# ![заголовок](pthn.png) **`ОШИБКИ  в PYTHON`** <a name="oshibki"></a>
